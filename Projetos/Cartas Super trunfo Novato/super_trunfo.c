...
int main(){
    ...
    char cod1[3], cod2[3] ; // Código da Carta 1 / Código da Carta 2 
    ...
    printf("Digite o número de habitantes da cidade (EX: 12345): \n"); // Vou melhorar colocando a pontuação certinha de mil, milhão e etc...
    scanf("%i", &populacao1);

    printf("Digite a Área da cidade em quilômetros quadrados (EX: 1200.02): \n"); // Adicionar KM² no terminal de saída.
    scanf("%f", &area1);
    ...
    scanf("%i", &turistico1);
        ...
        printf("\nDigite a Letra do Estado da Segunda Carta (EX: A - H): \n"); // Uma letra entre A e H.
        scanf("%s", &estado2);
